...
logger = Logger("train_linear")

def train_linear(data_path):
    logger.info("Starting linear models training pipeline")
    ...
    for name, model in models.items():
        ...
        model_path = f"models/linear_{name.lower()}_model.joblib"
